...
export const FireIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 3c.135 0 .27.002.403.005a7.5 7.5 0 0 1 5.242 13.083C17.26 12.583 14.828 10.5 12 10.5c-2.828 0-5.26 2.083-5.645 5.588A7.5 7.5 0 0 1 12 3Z" />
    </svg>
);
